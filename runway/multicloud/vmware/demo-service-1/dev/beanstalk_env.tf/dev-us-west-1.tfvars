...
tf_state_rds_bucket_name = "aws-us-west-1-dev-rds-tf-state-bucket"
tf_state_rds_key_name = "env:/dev/rds-dev.tfstate"

tf_state_beanstalk_app_bucket_name = "aws-us-west-1-dev-beanstalk-app-tf-state-bucket"
...
aws_terraform_demo_ec2_keypair_name = "aws-us-west-1-dev-terraform-demo-keypair"
