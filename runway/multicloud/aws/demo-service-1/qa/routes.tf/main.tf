...
source = "../../../modules/network/routes.tf"

  region = var.region
  environment = var.environment
  tf_state_vpc_bucket_name = var.tf_state_vpc_bucket_name
  tf_state_vpc_key_name = var.tf_state_vpc_key_name
  tf_state_gateways_bucket_name = var.tf_state_gateways_bucket_name
  tf_state_gateways_key_name = var.tf_state_gateways_key_name
