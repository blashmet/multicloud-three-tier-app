region = "us-east-2"
environment = "qa"
rds_secret_stack_name = "aws-us-east-2-qa-rds-secret"

tf_state_vpc_bucket_name = "aws-us-east-2-qa-vpc-tf-state-bucket"
tf_state_vpc_key_name = "env:/qa/vpc-qa.tfstate"

tf_state_rds_bucket_name = "aws-us-east-2-qa-rds-tf-state-bucket"
tf_state_rds_key_name = "env:/qa/rds-qa.tfstate"

tf_state_beanstalk_app_bucket_name = "aws-us-east-2-qa-beanstalk-app-tf-state-bucket"
tf_state_beanstalk_app_key_name = "env:/qa/beanstalk-app-qa.tfstate"

tf_state_security_groups_bucket_name = "aws-us-east-2-qa-security-groups-tf-state-bucket"
tf_state_security_groups_key_name = "env:/qa/security-groups-qa.tfstate"


#BEANSTALK APPLICATION VERSION
beanstalk_app_version_name = "aws-us-east-2-qa-terraform-demo-config"
beanstalk_app_version_description = "Application version managed by Terraform"
beanstalk_app_version_source_bucket_name = "aws-us-east-2-qa-beanstalk-source-bucket"
...
aws_terraform_demo_ec2_keypair_name = "aws-us-east-2-qa-terraform-demo-keypair"
