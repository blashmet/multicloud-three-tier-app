...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DataService = /** @class */ (function () {
                ...
                DataService.prototype.display_Json = function () {
                    this.ptld = this.get_BuildDefinition(2).pipe();
                    this.ptld.subscribe(function (data) { return console.log(JSON.stringify(data)); });
                };
                DataService.prototype.get_pizzatrackertimeline = function (myData) {
                    var _this = this;
                    var myttlArr = Array.of(myData.value);
                    var map = new Map();
                ...
                DataService.prototype.get_Persons = function () {
                    var url = this.basePersonUrl + 'api/Person/';
                    //console.log(url);
                    return this.httpClient.get(url);
                };
                DataService.prototype.call_TodoForNewEmployee = function (person) {
                    console.log(person);
                    this.get_CreateNewEmployeeTodos(person.id, person.firstname + " " + person.lastname);
                };
                DataService.prototype.put_Address = function (person) {
                    var _this = this;
                    //console.log(todo);
                    ...
                    //console.log(url);
                    if (newEmp) {
                        this.httpClient.put(url, person).subscribe(function (data) { return _this.call_TodoForNewEmployee(data); });
                    }
                    else {
                ...
                DataService.prototype.delete_Person = function (id) {
            ...
            var SignalRService = /** @class */ (function () {
                function SignalRService() {
                    ...
                    this.startConnection = function () {
                        var url = _this.baseToDoUrl + 'kafka';
                        console.log(url);
                        _this.hubConnection = new _microsoft_signalr__WEBPACK_IMPORTED_MODULE_4__["HubConnectionBuilder"]()
                            .withUrl(url)
                            .build();
                        _this.hubConnection
                            .start()
                    ...
                    this.addTransferKafkaDataListener = function () {
                        _this.hubConnection.on('transferkafkadata', function (data) {
                            _this.data = data;
                            //console.log(data);
                        });
                    };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            */
            var NameFilter = /** @class */ (function () {
                ...
                NameFilter.prototype.accepts = function (todo, search) {
            ...
            var EmployeeNameFilter = /** @class */ (function () {
                ...
                EmployeeNameFilter.prototype.accepts = function (person, search) {
                    console.log('here');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(document, dataService, router, httpClient, signalRService) {
                    var _this = this;
                    ...
                    this.startHttpRequest = function () {
                        _this.httpClient.get(_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlToDo + 'api/kafka')
                ...
                AppComponent.prototype.onTodoSubmit = function () {
                    var postedTodo;
                    postedTodo = {
                ...
                AppComponent.prototype.getPizzaTrackerItems = function (myData) {
                    this.ptl = this.dataService.get_pizzatrackertimeline(myData).pipe();
                    this.ptl.subscribe(function (val) { return console.log(val); });
                };
                AppComponent.prototype.getRunningBuilds = function (myData) {
                    var _this = this;
                    if (myData.count == 0) {
                        this.buildRunning = false;
                        console.log("No Running Build.");
                        if (this.lastBuiltID == 0) {
                            var tempRunBuild = this.dataService.get_LastRunBuild(2).pipe();
                            tempRunBuild.subscribe(function (data) { return _this.lastRunBuildDetails = data; });
                            ...
                            this.ptld.subscribe(function (data) { return _this.getPizzaTrackerItems(data); });
                            this.ptld = '';
                        }
                    }
                    else {
                ...
                AppComponent.prototype.getPizzatrackertimeline = function () {
                    var _this = this;
                    this.dataService.display_Json();
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(2000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["startWith"])(0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function () { return _this.dataService.get_RunningBuild(2); })).subscribe(function (data) { return _this.getRunningBuilds(data); });
                };
                AppComponent.prototype.populateTodo = function () {
                    this.todoItems = this.dataService.get_Todos();
                    this.todoItems.subscribe();
                };
                AppComponent.prototype.populateTodoFirstLoad = function () {
                    var _this = this;
                    this.todoItems = this.dataService.get_Todos();
                    var ds = this.dataService;
                    this.todoItems.subscribe(function (result) {
                        if (result.length === 0) {
                            //console.log(result.length)
                            _this.AddressItems.subscribe(function (x) {
                                var num = 1;
                ...
                AppComponent.prototype.onAddressSubmit = function () {
                    var _this = this;
                    var postedAddress;
                    postedAddress = {
                ...
                AppComponent.prototype.populateAddresses = function () {
                ...
                AppComponent.prototype.editAddress = function (person) {
                    //console.log(person);
                    this.addressForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormGroup"]({
                ...
                AppComponent.prototype.changeFile = function (file) {
                ...
                AppComponent.prototype.uploadFile = function (event) {
                    ...
                    if (event.target.value) {
                        ...
                        var type = file.type;
                        this.changeFile(file).then(function (base64) {
                            console.log(base64);
                            //this.fileBlob = this.b64Blob([base64], type);
                            //console.log(this.fileBlob)
                            _this.ppData = base64;
                            _this.addressForm.get('profilepicture').setValue(base64);
                        });
                    }
                    else
                        alert('Nothing');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppInitService = /** @class */ (function () {
                ...
                AppInitService.prototype.init = function () {
                    ...
                    })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (config) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DynamicEnvironment = /** @class */ (function () {
                ...
                Object.defineProperty(DynamicEnvironment.prototype, "isProduction", {
                    get: function () {
                ...
                Object.defineProperty(DynamicEnvironment.prototype, "urlAddress", {
                    get: function () {
                ...
                Object.defineProperty(DynamicEnvironment.prototype, "urlToDo", {
                    get: function () {
                ...
                Object.defineProperty(DynamicEnvironment.prototype, "deployLocation", {
                    get: function () {
                ...
                Object.defineProperty(DynamicEnvironment.prototype, "urlDadJoke", {
                    get: function () {
                ...
                Object.defineProperty(DynamicEnvironment.prototype, "version", {
                    get: function () {
                ...
                Object.defineProperty(DynamicEnvironment.prototype, "urlPerson", {
                    get: function () {
                ...
                Object.defineProperty(DynamicEnvironment.prototype, "urlDevOps", {
                    get: function () {
                ...
                Object.defineProperty(DynamicEnvironment.prototype, "azPAT", {
                    get: function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Environment = /** @class */ (function (_super) {
                ...
                return Environment;
            }(_dynamic_environment__WEBPACK_IMPORTED_MODULE_1__["DynamicEnvironment"]));
